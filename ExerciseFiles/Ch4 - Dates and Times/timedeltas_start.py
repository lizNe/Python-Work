...
from datetime import timedelta # timedelta class. It is a span of time or amount . Used to perform time based math
...
# print("The date it was last week: ", str(now - timedelta(weeks=1)))
